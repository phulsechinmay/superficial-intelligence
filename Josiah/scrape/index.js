...
const plotMap = () => {
    ...
    getData('comments').then((locations) => plotHeatmap(locations, map));
    getData('comments').then((locations) => plotCommentData(locations, map));
    getData('success').then((locations) => plotSuccessData(locations, map));
    addLegend(map);
};
